...
RUN echo $SKIP_PREFLIGHT_CHECK &&\
    echo $NODE_ENV &&\
    echo $REACT_APP_HOTJAR_CODE &&\
    echo $REACT_APP_HOTJAR_CODE_VERSION &&\
    echo $REACT_APP_METADATA_CATALOG_URL &&\
    echo $REACT_APP_NEWSLETTER_EXAMPLE_URL &&\
    echo $REACT_APP_GATEWAY_PRIVACY_POLICY_URL
