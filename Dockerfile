...
ARG NEXT_PUBLIC_API_V2_IP_URL
ARG NEXT_PUBLIC_API_V3_URL
ARG NEXT_PUBLIC_API_V3_IP_URL
...
ARG NEXT_PUBLIC_SCHEMA_BRANCH
ARG NEXT_PUBLIC_GTM_ID
ARG NEXT_PUBLIC_OA_APP_ID
ARG NEXT_PUBLIC_INCLUDE_BANNERS
ARG NEXT_PUBLIC_MEDIA_DOMAIN
ARG NEXT_PUBLIC_MEDIA_STATIC_URL
ARG NEXT_PUBLIC_PREDEFINED_INTEGRATION_OVERVIEW_URL
ARG NEXT_PUBLIC_CUSTOM_INTEGRATION_OVERVIEW_URL
ARG NEXT_PUBLIC_CONFLUENCE_URL
