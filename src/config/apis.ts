...
const apis = {
    ...
    adminSearchStatusV1Url: `${apiV1IPUrl}/admin/search/status`,
    adminSearchReindexV1Url: `${apiV1IPUrl}/admin/search/reindex`,
    ...
    toolsV2Url: `${apiV2Url}/tools`,
    toolsV2UrlIP: `${apiV2IPUrl}/tools`,
