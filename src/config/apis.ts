...
const apis = {
    ...
    adminTeamsV1Url: `${apiV1Url}/admin/teams`,
    adminTeamsV1UrlIP: `${apiV1IPUrl}/admin/teams`,
    adminUsersV1Url: `${apiV1Url}/admin/users`,
    adminUsersV1UrlIP: `${apiV1IPUrl}/admin/users`,
    ...
    datasetLinkCheckResultsV2Url: `${apiV2IPUrl}/dataset_link_check_results`,
