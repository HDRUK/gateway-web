...
describe("LeftNav", () => {
    ...
    it("renders expanded items", () => {
        ...
        expect(within(links[1]).getByText("Team members")).toBeInTheDocument();
        expect(
            within(links[3]).getByText("Custom Integrations")
        ).toBeInTheDocument();
        expect(
            within(links[4]).getByText("Predefined Integrations")
        ).toBeInTheDocument();
        expect(within(links[5]).getByText("Help")).toBeInTheDocument();
    });
