        ...
        "$defs": {
            ...
            "EnvironmentAndEnergy": {
                "properties": {
                    "name": {
                        "Literal": true,
                        "default": "Environment and energy",
                        "title": "Name",
                        "type": "string"
                    },
                    "subTypes": {
                ...
                "properties": {
                    ...
                    "subTypes": {
                        "anyOf": [
                            {
                                "items": {
                                    "$ref": "#/$defs/OmicsDataTypeSubTypes"
                                },
                                "type": "array"
                            },
                            {
                ...
                "properties": {
                    ...
                    "datasetType": {
                        ...
                        "items": {
                            "anyOf": [
                                {
                                    "$ref": "#/$defs/HealthAndDisease"
                                },
                                {
                                    "$ref": "#/$defs/TreatmentsInterventions"
                                },
                                {
                                    "$ref": "#/$defs/MeasurementsTests"
                                },
                                {
                                    "$ref": "#/$defs/ImagingTypes"
                                },
                                {
                                    "$ref": "#/$defs/ImagingAreaOfTheBody"
                                },
                                {
                                    "$ref": "#/$defs/OmicsDataType"
                                },
                                {
                                ...
                                {
                                    "$ref": "#/$defs/EnvironmentAndEnergy"
                                },
                                {
                                    "$ref": "#/$defs/InformationAndCommunication"
                                },
                                {
                                    "$ref": "#/$defs/Politics"
                                }
                ...
                "properties": {
                    ...
                    "subTypes": {
                        "anyOf": [
                            {
                                "items": {
                                    "$ref": "#/$defs/SocioeconomicSubTypes"
                                },
                                "type": "array"
                            },
                            {
            ...
            "TreatmentsInterventions": {
                "properties": {
                    "name": {
                        "Literal": true,
                        "default": "Treatments/Interventions",
                        "title": "Name",
                        "type": "string"
                    },
                    "subTypes": {
                        "anyOf": [
                            {
                                "items": {
                                    "$ref": "#/$defs/TreatmentsInterventionsSubTypes"
                                },
                                "type": "array"
                            },
                            {
            ...
            "TreatmentsInterventionsSubTypes": {
                ...
                "title": "TreatmentsInterventionsSubTypes",
                "type": "string"
            },
            "Url": {
                "anyOf": [
