...
const TRANSLATION_PATH =
    "pages.account.profile.collections.components.Collections";
...
const Collections = ({
    ...
    const { data: counts, mutate: mutateCount } = useGet<CountStatus>(`${apis.collectionsV1Url}/count/status?user_id=${userId}`);
    ...
    const handleAdd = () => {
        const COLLECTION_CREATE_ROUTE = `/${RouteName.ACCOUNT}/${RouteName.PROFILE}/${RouteName.COLLECTIONS}/${RouteName.CREATE}`;
