                    ...
                    userState: [
                        {
                            ...
                            acceptedAdvancedSearchTerms:
                                res.data.data[0].acceptedAdvancedSearchTerms,
                    ...
                    <div className="mainWrap" onScroll={this.handleScroll}>
                        <Switch>
                            ...
                            <Route
                                path="/loginerror"
                                render={(props) => (
                                    <LoginErrorPage {...props} userState={userState} />
                                )}
                            />
                            <Route
                                path="/person/:personID"
                                render={(props) => <PersonPage {...props} userState={userState} />}
                            />
                            <Route
                            ...
                            <Route
                                ...
                                render={(props) => (
                                    <CompleteRegistration {...props} userState={userState} />
                                )}
                            />
                            <Route
                                path="/sso"
                                render={(props) => <SSOPage {...props} userState={userState} />}
                            />
                            <Route
                            ...
                            <Route
                                path="/dashboard"
                                render={(props) => (
                                    <PublicAnalyticsDashboard {...props} userState={userState} />
                                )}
                            />

                            <GuardedRoute
                                path="/dataset-onboarding/:id"
                                component={DatasetOnboarding}
                                userState={userState}
                            />
                            <GuardedRoute
                            ...
                            <Route
                                ...
                                render={(props) => (
                                    <CollectionPage {...props} userState={userState} />
                                )}
                            />
                            <GuardedRoute
                                path="/tool/add"
                                component={AddEditToolPage}
                                userState={userState}
                            />
                            <GuardedRoute
                            ...
                            <Route
                                ...
                                render={(props) => <ProjectPage {...props} userState={userState} />}
                            />
                            <GuardedRoute
                                path="/paper/add"
                                component={AddEditPaperPage}
                                userState={userState}
                            />
                            <GuardedRoute
                            ...
                            <Route
                                path="/paper/:paperID"
                                render={(props) => <PaperPage {...props} userState={userState} />}
                            />
                            <GuardedRoute
                                path="/course/add"
                            ...
                            <Route
                                ...
                                render={(props) => <CoursePage {...props} userState={userState} />}
                            />
                            <Route
