        ...
        <>
            <Modal show={open} onHide={close} aria-labelledby='contained-modal-title-vcenter' centered className='deleteDraftModal'>
                ...
                <div className='deleteDraftModal-body'>
                    Are you sure you want to delete this draft application? You will no longer be able to view this form and will lose any
                    answers provided. All applicants and contributors will be notified.
                </div>
