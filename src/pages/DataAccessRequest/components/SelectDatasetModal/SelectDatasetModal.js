            ...
            >
                <div className='selectDatasetModal-header'>
                    ...
                    <div className='selectDatasetModal-header-description'>
                        Search for datasets you wish to add to your new data access request application. Only datasets with matching form
                        application processes will be available to select from. If you can’t find the dataset you need, you will need to
                        start a new data access request application.
                    </div>
                </div>
