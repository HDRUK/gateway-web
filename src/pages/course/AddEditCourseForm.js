                                        ...
                                        <Form onSubmit={formik.handleSubmit} onBlur={formik.handleBlur} autocomplete='off'>
                                                                                    ...
                                                                                    <div className='main-accordion-body'>
                                                                                        <div className='form-group'>
                                                                                            ...
                                                                                            <small className='form-text mb-2'>
                                                                                                If the start date is flexible, for instance
                                                                                                if it is a self-taught course that you can
                                                                                                begin at any time, select the checkbox.
                                                                                            </small>
                                                                                            <div className='row mb-2'>
                                                                                                <Form.Control
                                                                                                    ...
                                                                                                    onChange={formik.handleChange}
                                                                                                />
                                                                                                <span className='gray800-14 ml-4'>
                                                                                                    This course has flexible dates
                                                                                                </span>
                                                                                            </div>
                                                                                        </div>
                                                                                        ...
                                                                                        <Row className='mt-2'>
                                                                                            <Col sm={12}>
                                                                                                ...
                                                                                                <p className='gray700-13 margin-bottom-0'>
                                                                                                    Input the duration for this course
                                                                                                    option. If this course does not have a
                                                                                                    set duration, for example if it’s
                                                                                                    self-taught, please input an expected
                                                                                                    duration.
                                                                                                </p>
                                                                                            </Col>
                                                                                            <Col sm={4}>
                                                                                        ...
                                                                                        <Row className='mt-2'>
                                                                                            <Col sm={12}>
                                                                                                ...
                                                                                                <p className='gray700-13 margin-bottom-0'>
                                                                                                    Include details of the fees for each
                                                                                                    type of applicant for this course
                                                                                                    option, as well as the time frame the
                                                                                                    fee applies to.
                                                                                                </p>
                                                                                            </Col>
                                                                                            <Col sm={6}>
                                                                                        ...
                                                                                        <div
                                                                                            ...
                                                                                            <button
                                                                                                ...
                                                                                                disabled={
                                                                                                    formik.values.courseOptions.length < 2
                                                                                                }
                                                                                                onClick={async e => {
                                                                                                    e.preventDefault();
                                                                                                    removePhase(index);
                                            ...
                                            <div className='rectangle pixelGapTop'>
                                                <Row className='mt-2'>
                                                    <Col sm={12}>
                                                        ...
                                                        <p className='gray700-13 margin-bottom-0'>
                                                            Detail the relevant requirements an applicant must hold to apply for this course
                                                            option.
                                                        </p>
                                                    </Col>
                                                    <Col sm={5}>
                                                                        ...
                                                                        <>
                                                                            ...
                                                                            <Col
                                                                                ...
                                                                                <button
                                                                                    ...
                                                                                    className='plusMinusButton'
                                                                                    disabled={
                                                                                        formik.values.entries.length >= 5 ||
                                                                                        indexC !== formik.values.entries.length - 1
                                                                                    }
                                                                                    onClick={() => {
                                                                                        push(new Entries());
                                                ...
                                                <Form.Group>
                                                    ...
                                                    <p className='gray700-13 margin-bottom-0'>
                                                        E.g. Open/none, open to current students, open to employees, not open to visiting
                                                        students
                                                    </p>
                                                    <Form.Control
                                                        id='restrictions'
                                                ...
                                                <Form.Group>
                                                    ...
                                                    <p className='gray700-13 margin-bottom-0'>
                                                        E.g. CPD, Fellowship, PhD, CPE, PGCert, PGDip, MSc, DPhil
                                                    </p>
                                                    <Typeahead
                                                        id='award'
                                                        labelKey='award'
                                                ...
                                                <Form.Group>
                                                    <p className='gray800-14 margin-bottom-0 pad-bottom-4'>
                                                        National priority areas (optional)
                                                    </p>
                                                    <p className='gray700-13 margin-bottom-0'>
                                                        E.g. Understanding the causes of disease, Clinical trials, Improving Public Health
                                                        and Better Care
                                                    </p>
                                                    <DropdownButton
                                                        variant='white'
                                            ...
                                            <div className='rectangle mt-2'>
                                                ...
                                                <span className='gray800-14'>
                                                    Show relationships to papers, data uses, datasets, tools and courses. Resources must be
                                                    added to the Gateway first.
                                                </span>
                                            </div>
