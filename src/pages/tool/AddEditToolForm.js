                                            ...
                                            <div className='rectangle'>
                                                ...
                                                <Form.Group data-test-id='description'>
                                                    <div style={{ display: 'inline-block' }}>
                                                        ...
                                                        <p className='gray700-13 margin-bottom-0'>
                                                            Include the tool purpose and objective.
                                                        </p>
                                                    </div>
                                                ...
                                                <Form.Group>
                                                    <div style={{ display: 'inline-block' }}>
                                                        ...
                                                        <p className='gray700-13 margin-bottom-0'>
                                                            Include any results or insights about the tool.
                                                        </p>
                                                    </div>
                                                    <div style={{ display: 'inline-block', float: 'right' }}>
                                                        <br />
                                                        <span className='gray700-13'>
                                                            (
                                                            <span id='resultsInsightsCurrentCount'>
                                                ...
                                                <p className='gray700-13 margin-bottom-0'>
                                                    Please add the names of the people who authored this tool, using a comma to separate the
                                                    names
                                                </p>
                                                <Form.Control
                                                    id='authorsNew'
                                                                            ...
                                                                            <Col sm={12} md={8}>
                                                                                <Form.Group
                                                                                    ...
                                                                                    <Typeahead
                                                                                        ...
                                                                                        selected={[
                                                                                            formik.values.programmingLanguage[index]
                                                                                                .programmingLanguage,
                                                                                        ]}
                                                                                        allowNew
                                                                                        className={
                                                                                            ...
                                                                                            typeof formik.errors.programmingLanguage[
                                                                                                index
                                                                                            ] !== 'undefined' &&
                                                                                        ...
                                                                                        onChange={selected => {
                                                                                            ...
                                                                                            tempSelected.length > 0
                                                                                                ? (formik.values.programmingLanguage[
                                                                                                      index
                                                                                                  ].programmingLanguage = tempSelected[0])
                                                                                                : (formik.values.programmingLanguage[
                                                                                                      index
                                                                                                  ].programmingLanguage = '');
                                                                                        }}
                                                                                    ...
                                                                                    formik.errors.programmingLanguage &&
                                                                                    formik.errors.programmingLanguage[index] &&
                                                                                    typeof formik.errors.programmingLanguage[index] !==
                                                                                        'undefined' &&
                                                                                    formik.touched.programmingLanguage[index] &&
                                                                            ...
                                                                            <Col
                                                                                ...
                                                                                <button
                                                                                    ...
                                                                                    disabled={
                                                                                        ...
                                                                                        index !==
                                                                                            formik.values.programmingLanguage.length - 1
                                                                                    }
                                                                                    onClick={() => {
