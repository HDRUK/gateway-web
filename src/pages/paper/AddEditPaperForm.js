                                    ...
                                    <Form onSubmit={formik.handleSubmit} onBlur={formik.handleBlur} autocomplete='off'>
                                        <div className='rectangle'>
                                            ...
                                            <Row className='mt-2'>
                                                <Col sm={12} lg={8}>
                                                    ...
                                                    <p className='gray700-13 margin-bottom-0'>
                                                        If you don’t have a DOI please add an alternative URL or PDF full text link. You may
                                                        add several.
                                                    </p>
                                                </Col>
                                            </Row>
                                            ...
                                            <Form.Group>
                                                ...
                                                <p className='gray700-13 margin-bottom-0'>
                                                    Please add the names of the people who authored this paper, using a comma to separate
                                                    the names
                                                </p>
                                                <Form.Control
                                                    id='authorsNew'
                                                                ...
                                                                {isPreprintToolTipShown && (
                                                                    <div className='preprintFormToolTip'>
                                                                        <span className='white-13-semibold'>
                                                                            ...
                                                                            uploads on a public server for free viewing. Initially it is
                                                                            posted without peer review, but may acquire feedback or reviews
                                                                            as a preprint, and may eventually be published in a
                                                                            peer-reviewed journal. The posting of preprints on public
                                                                            servers allows almost immediate dissemination and scientific
                                                                            feedback early in the 'publication' process.
                                                                        </span>
                                                                    </div>
                                                                )}
                                                            </Col>
                                        ...
                                        <div className='rectangle mt-2'>
                                            ...
                                            <span className='gray800-14'>
                                                Show relationships to papers, data uses, datasets and tools. Resources must be added to the
                                                Gateway first.
                                            </span>
                                        </div>
