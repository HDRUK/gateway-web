...
const AddEditPaperForm = (props) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            if (props.isEdit) {
                axios.put(baseURL + '/api/v1/papers/' + props.data.id, values)  
                .then((res) => {
                    window.location.href = window.location.search + '/paper/' + props.data.id + '/?paperEdited=true';
                });
            }
            else {
                axios.post(baseURL + '/api/v1/papers/', values)
                    .then((res) => {
          ...
          <Col sm={10} lg={10}>
            <div className="rectangle">
              <Row>
                <Col sm={10} lg={10}>
                  <p className="black-20 margin-bottom-0 pad-bottom-8">
                    {props.isEdit ? "Edit your paper" : "Add a new paper"}
                  </p>
                </Col>
              ...
              <p className="gray800-14 margin-bottom-0">
                Papers should be articles published in a journal. Add a project
                if you want
              </p>
            </div>
          </Col>
            ...
            >
              <div className="rectangle">
                <Form.Group>
                  ...
                  {formik.status && formik.status.duplicateLink ? (
                    <div className="errorMessages">
                      {formik.status.duplicateLink}
                    </div>
                  ) : null}
                </Form.Group>
                ...
                <Form.Group>
                  <p className="gray800-14 margin-bottom-0 pad-bottom-4">
                    Authors on the Gateway
                  </p>
                  <p className="gray700-13 margin-bottom-0">
                    Add any authors or collaborators who have an account on this
                    site
                  </p>
                  <Typeahead
                    id="authors"
                          ...
                          {isShown && (
                            <div className="preprintFormToolTip"> 
                              <span className="white-13-semibold">
                                ...
                                free viewing. Initially it is posted without
                                peer review, but may acquire feedback or reviews
                                as a preprint, and may eventually be published
                                in a peer-reviewed journal. The posting of
                                preprints on public servers allows almost
                                immediate dissemination and scientific feedback
                                early in the 'publication' process.
                              </span>
                            </div>
                          )}
                        </Col>
                  ...
                  <Row className="mt-2">
                    <Col sm={10}>
                      <Form.Group>
                        ...
                        {formik.touched.journalYear &&
                        formik.errors.journalYear ? (
                          <div className="errorMessages">
                            {formik.errors.journalYear}
                          </div>
                        ) : null}
                ...
                <Form.Group>
                  ...
                  <p className="gray700-13 margin-bottom-0">
                    Technological paradigms or other keywords. Eg. Rule-based,
              ...
              <div className="rectangle mt-2">
                ...
                <br />
                <span className="gray800-14">
                  Show relationships to papers, projects, datasets and tools.
