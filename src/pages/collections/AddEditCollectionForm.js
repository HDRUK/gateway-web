                            ...
                            <Row>
                                <Col sm={12} lg={12}>
                                    <p className='black-20 margin-bottom-0 pad-bottom-8'>
                                        {props.isEdit ? 'Edit a collection' : 'Create a collection'}
                                    </p>
                                </Col>
                            </Row>
                            <p className='gray800-14 margin-bottom-0'>
                                Collections help collate varying resource types into one discovery space
                            </p>
                        </div>
                    </Col>
                    <Col sm={1} lg={10} />
                                ...
                                <Form.Group className='margin-bottom-24'>
                                    <Row>
                                        <Col sm={7} lg={9}>
                                            ...
                                            <p className='gray700-13 margin-bottom-0'>
                                                Paste an image address URL. Optimal image size: W750 x H400
                                            </p>
                                        </Col>
