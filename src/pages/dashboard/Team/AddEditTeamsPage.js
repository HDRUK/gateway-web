                        ...
                        <Col sm={12} lg={12}>
                            <Row className='mt-3'>
                                <Col sm={12} lg={12}>
                                    ...
                                    <p className='gray700-13 mb-0'>
                                        Please ensure the name matches the standard format for organisation names
                                    </p>
                                </Col>
                            </Row>
                            <Row>
                                <Col sm={12} lg={12}>
                                    <Form.Group className='pb-2'>
                                        <Form.Control
                                            ...
                                            type='text'
                                            className={
                                                formik.touched.name && formik.errors.name ? 'emptyFormInput addFormInput' : 'addFormInput'
                                            }
                            ...
                            <Row>
                                <Col sm={12} lg={12}>
                                    ...
                                    <p className='gray700-13 mb-0'>
                                        Assign at least one team manager. They will be able to manage members, create and assign workflows,
                                        review applications that are assigned to them and make the final decision on data access request
                                        applications. They cannot be removed once the team is published
                                    </p>
                                </Col>
                            </Row>
                            <Row>
                            ...
                            <Row>
                                <Col sm={12} lg={12}>
                                    ...
                                    <p className='gray700-13 mb-0'>
                                        Please provide a valid email address that can be used as a default if not provided by the custodian
                                        when filling in the metadata form
                                    </p>
                                </Col>
                            </Row>
                            <Row>
