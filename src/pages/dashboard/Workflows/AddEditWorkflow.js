                                    ...
                                    <div className='main-header'>
                                        <div className='main-header-desc'>
                                                    ...
                                                    <>
                                                        <Field
                                                            ...
                                                            className={`form-control ${
                                                                errors.workflowName && touched.workflowName ? 'is-invalid' : ''
                                                            }`}
                                                        />
                                            ...
                                            <div className='soft-black-14'>
                                                Workflows are the frameworks used by your team to respond to data access request
                                                applications.
                                            </div>
                                        </div>
                                                                    ...
                                                                    <SlideDown closed={node.expand}>
                                                                        <div className='main-accordion-body'>
                                                                            ...
                                                                            <div className='form-group'>
                                                                                ...
                                                                                <small className='form-text mb-2'>
                                                                                    Reviewers can see all sections of the application, but
                                                                                    can only interact with and review their assigned
                                                                                    sections
                                                                                </small>
                                                                            ...
                                                                            <div className='form-group'>
                                                                                ...
                                                                                <small className='form-text'>
                                                                                    The first phase will begin once the workflow manager has
                                                                                    started the review. The following phases begin once a
                                                                                    decision has been made by all reviewers on the previous
                                                                                    phase, or once the manager has progressed the review to
                                                                                    the next phase. Reviewers will be notified when their
                                                                                    assigned phase has begun.
                                                                                </small>
                                                                            </div>
                                                                            <div className='form-group'>
                                                                                <label
                                                                                ...
                                                                                <small className='form-text mb-2'>
                                                                                    Reviewers will be notified 3 day before the deadline.
                                                                                    The manager can progress the application to the next
                                                                                    phase at any time.
                                                                                </small>
                                                                                <div className='form-inline'>
                                                                                    ...
                                                                                    <small className='ml-2'>
                                                                                        days after the start of this phase
                                                                                    </small>
                                                                                </div>
                                                                                {hasErrors(touched, errors, index, 'deadline') ? (
                                                                                    <div className='errorMessages'>
