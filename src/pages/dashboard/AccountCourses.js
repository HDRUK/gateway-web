														...
														return (
															<Row className='entryBox' key={i}>
																...
																<Col sm={12} lg={5} className='pt-2'>
																	<a href={'/course/' + dat.id} className='black-14'>
																		{dat.title}
																	</a>
																</Col>
																<Col sm={12} lg={2} className='pt-2 gray800-14'>
																...
																<Col sm={12} lg={3} style={{ textAlign: 'right' }} className='toolsButtons'>
																	<DropdownButton variant='outline-secondary' alignRight title='Actions' className='floatRight'>
																		<Dropdown.Item href={'/course/' + dat.id} className='black-14'>
																			View
																		</Dropdown.Item>
																		<Dropdown.Item href={'/course/edit/' + dat.id} className='black-14'>
																			Edit
																		</Dropdown.Item>
																...
																<Col sm={12} lg={3} style={{ textAlign: 'right' }} className='toolsButtons'>
																	{userState[0].role === 'Admin' ? (
																		<DropdownButton variant='outline-secondary' alignRight title='Actions' className='floatRight'>
																			...
																			<Dropdown.Item href='#' onClick={() => this.approveCourse(dat.id)} className='black-14'>
																				Approve
																			</Dropdown.Item>
