													...
													if (dat.messageType === 'add') {
														return (
															<>
																...
																<a href={'/' + dat.tool[0].type + '/' + dat.tool[0].id}>{dat.tool[0].name}</a> is now available for review.
															</>
														);
														...
														if (dat.messageTo === 0) {
															return (
																<>
																	{messageDateString} - The {dat.tool[0].type}{' '}
																	<a href={'/' + dat.tool[0].type + '/' + dat.tool[0].id}>{dat.tool[0].name}</a> has been approved.
																</>
															);
														} else {
															return (
														...
														if (dat.messageTo === 0) {
															return (
																<>
																	{messageDateString} - The {dat.tool[0].type}{' '}
																	<a href={'/' + dat.tool[0].type + '/' + dat.tool[0].id}>{dat.tool[0].name}</a> has been rejected.
																</>
															);
														} else {
															return (
