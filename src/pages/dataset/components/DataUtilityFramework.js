				...
				<Modal.Header className='bottomBorder'>
					<Modal.Title>
						<Row className='dataUtilityClose'>
							<CloseButtonSvg className='modal-close pointer' onClick={handleClose} width='24px' height='24px' fill='#475DA7' />
						</Row>
						<Row id='dataUtilityHeader'>
							...
							<p className='gray-deep-14 margin-bottom-8'>
								The Data Utility Framework scores datasets on 5 categories and 23 dimensions, and is used to refer to the usefulness of a
								dataset for a given purpose. This table displays all classifications for all the dimensions, allowing you to compare the
								scores and their linked definitions.
							</p>
							<a
								href='https://www.hdruk.ac.uk/help-with-your-data/ways-to-improve-data-quality/data-utility-evaluation/'
								target='_blank'
