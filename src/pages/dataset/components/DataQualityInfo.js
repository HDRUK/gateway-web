		...
		switch (section) {
			...
			case 'TechQuality':
				if (techQualitySection === true) {
					return (
						<div className='dataQualityCollapse'>
							<Row className='pointer dataUtilityRow margin-top-8' onClick={() => this.setState({ open: !open, flagClosed: !flagClosed })}>
								<Col xs={2} sm={2} m={1} lg={1} className='dataUtilityChevron'>
									<SVGIcon
										name='chevronbottom'
										fill={'#475DA7'}
							...
							<Collapse in={this.state.open} className='dataCollapseWait pad-top-8'>
								<div>
									<Row className='dataUtilityBox topBorder'>
										...
										<Col sm={1} lg={1}>
											<span>
												{!_.isEmpty(data_quality_management_process) && this.getSubSectionRating(data_quality_management_process.trim())}
											</span>
										</Col>
									</Row>
									<Row className='dataUtilityBox'>
										...
										<Col sm={1} lg={1}>
											<span>{!_.isEmpty(dama_quality_dimensions) && this.getSubSectionRating(dama_quality_dimensions.trim())}</span>
										</Col>
									</Row>
								</div>
							</Collapse>
