...
import RelatedResourcesSearch from '../relatedResources/RelatedResourcesSearch';
							...
							{(() => {
								if (data.type === 'tool') {
																...
																if (onSearchPage === true) {
																	return (
																		<span
																			className='pointer'
																			onClick={event =>
																				this.updateOnFilterBadge('projectFeaturesSelected', {
																					label: feature,
																					parentKey: 'projectfeatures',
																				})
																			}
									...
									const phenotypesSelected = queryString.parse(window.location.search).phenotypes
										...
										: [];
									const searchTerm = queryString.parse(window.location.search).search
										? queryString.parse(window.location.search).search
										: '';
