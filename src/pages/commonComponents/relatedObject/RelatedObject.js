					...
					<div
						...
						{(() => {
							if (data.type === 'tool') {
													...
													<span className='gray800-14 margin-left-10'>
														{(() => {
															...
															if (onSearchPage === true) {
																...
																if (data.courseOptions.startDate && data.courseOptions.studyMode)
								...
								//default to dataset
								var phenotypesSelected = queryString.parse(window.location.search).phenotypes
								...
								var phenotypesSeached = data.datasetfields.phenotypes.filter(
