                                                ...
                                                <InputGroup className='mb-2'>
                                                    <InputGroup.Prepend>
                                                        <InputGroup.Radio
                                                            ...
                                                            checked={
                                                                entry.label ===
                                                                selectedItems.find(item => item.parentKey === step.key)?.label
                                                            }
                                                        />
                                                    </InputGroup.Prepend>
                                                    <FormText className='ml-3'>
                                                        {entry.labelAlias ? entry.labelAlias : entry.label}
                                                    </FormText>
                                                </InputGroup>
                                            );
                                        })}
            ...
            <div className='data-utility-wizard-header'>
                ...
                <div className='data-utility-wizard-header--wrap'>
                    ...
                    <div className='Use-this-tool-to-fin'>
                        Use this tool to find the datasets you require through 6 key data utility filters: allowable uses, time lag, length
                        of follow up, data model, provenance and search terms.
                    </div>
                </div>
            </div>
