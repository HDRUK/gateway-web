						...
						<div className='rectangle'>
							...
							{!orcid || !showOrcid ? (
								...
								<Row>
									...
									<Col xs={9} md={9}>
										<a href={orcid} rel='noopener noreferrer' target='_blank' className='purple-14 overflowWrap'>
											{orcid}
										</a>
									</Col>
								</Row>
							...
							{!link || !showLink ? (
								...
								<Row>
									...
									<Col xs={11} md={9}>
										<a href={link} rel='noopener noreferrer' target='_blank' className='purple-14 overflowWrap'>
											{link}
										</a>
									</Col>
								</Row>
