								...
								<Col sm={10} lg={10}>
									<div className='rectangle'>
										...
										<p className='gray800-14 margin-bottom-0'>
											...
											Data uses help people understand how data is being used and why. Please edit data uses to ensure that the information
													...
													<Card.Body className='datause-card-body'>
														<Form>
															...
															<Form.Group>
																...
																<Form.Control
																	...
																	{organisationSectorList.map(l => (
																		<option selected={formik.values.organisationSector === l} value={l} key={l} eventKey={l}>
																			{l}
																		</option>
																	))}
																</Form.Control>
															...
															<Form.Group>
																...
																<p className='gray800-13-opacity datause-edit-p'>
																	The name of the Principal Investigator, as well as any other individuals that have been authorised to use
																	the data. If they are on the Gateway, please provide their profile URL
																</p>
																<Typeahead
																	disabled={disableInput}
																	id='applicants'
															...
															<Form.Group>
																...
																<Form.Control
																	...
																	onBlur={formik.handleBlur}>
																	{yesNoList.map(l => (
																		<option selected={formik.values.accreditedResearcherStatus === l} value={l} key={l} eventKey={l}>
																			{l}
																		</option>
																	))}
																</Form.Control>
															...
															<Form.Group>
																...
																<p className='gray800-13-opacity datause-edit-p'>
																	...
																	e.g., NHS Digital may approve a data release to the ONS, who then makes decisions about access to
																	accredited researchers undertaking approved projects in their own trusted research environment.
																</p>
																<Form.Control
																	as='select'
																	disabled={disableInput}
																	...
																	onBlur={formik.handleBlur}>
																	{yesNoList.map(l => (
																		<option selected={formik.values.sublicenceArrangements === l} value={l} key={l} eventKey={l}>
																			{l}
																		</option>
																	))}
																</Form.Control>
													...
													<Card.Body className='datause-card-body'>
														<Form>
															<Form.Group>
																...
																<p className='gray800-13-opacity datause-edit-p'>
																	A unique identifier for the project that is preferably an industry used standard, such as IRAS ID. However
																	for non-research projects, a unique reference number created by the data custodian on receipt of the
															...
															<Form.Group>
																...
																<Form.Control
																	...
																	{requestCategoryTypeList.map(l => (
																		<option selected={formik.values.requestCategoryType === l} value={l} key={l} eventKey={l}>
																			{l}
																		</option>
																	))}
																</Form.Control>
													...
													<Card.Body className='datause-card-body'>
														<Form>
															...
															<Form.Group>
																...
																<Form.Control
																	...
																	{dataSensitivityLevelList.map(l => (
																		<option selected={formik.values.dataSensitivityLevel === l} value={l} key={l} eventKey={l}>
																			{l}
																		</option>
																	))}
																</Form.Control>
															...
															<Form.Group>
																...
																<p className='gray800-13-opacity datause-edit-p'>
																	The lawful basis for processing are set out in Article 6 of the GDPR. At least one legal basis must apply
																	whenever you process personal data. Please select appropriate Article 6 lawful basis. Processing shall be
																...
																<Form.Control
																	...
																	{legalBasisForDataArticle6List.map(l => (
																		<option selected={formik.values.legalBasisForDataArticle6 === l} value={l} key={l} eventKey={l}>
																			{l}
																		</option>
																	))}
																</Form.Control>
															...
															<Form.Group>
																...
																<p className='gray800-13-opacity datause-edit-p'>
																	...
																	person's sex life or sexual orientation shall be prohibited. This does not apply if one of the following
																	applies
																</p>
																<Form.Control
																	as='select'
																	...
																	{legalBasisForDataArticle9List.map(l => (
																		<option selected={formik.values.legalBasisForDataArticle9 === l} value={l} key={l} eventKey={l}>
																			{l}
																		</option>
																	))}
																</Form.Control>
															...
															<Form.Group>
																...
																<p className='gray800-13-opacity datause-edit-p'>
																	...
																	and Wales, if you are using section 251 of the NHS Act 2006 (s251) as a legal basis for identifiable data,
																	you will need to ensure that you have the latest approval letter and application. For Scotland this
																	application will be reviewed by the Public Benefit and Privacy Panel. In Northern Ireland it will be
																	considered by the Privacy Advisory Committee. If you are using patient consent as the legal basis, you
																	will need to provide all relevant consent forms and information leaflets.
																</p>
																<Form.Control
																	as='select'
																	disabled={disableInput}
																	...
																	{dutyOfConfidentialityList.map(l => (
																		<option selected={formik.values.dutyOfConfidentiality === l} value={l} key={l} eventKey={l}>
																			{l}
																		</option>
																	))}
																</Form.Control>
															...
															<Form.Group>
																...
																<Form.Control
																	...
																	onBlur={formik.handleBlur}>
																	{yesNoNotList.map(l => (
																		<option selected={formik.values.nationalDataOptOut === l} value={l} key={l} eventKey={l}>
																			{l}
																		</option>
																	))}
																</Form.Control>
															...
															<Form.Group>
																...
																<Form.Control
																	...
																	{requestFrequencyList.map(l => (
																		<option selected={formik.values.requestFrequency === l} value={l} key={l} eventKey={l}>
																			{l}
																		</option>
																	))}
																</Form.Control>
															...
															<Form.Group>
																...
																<p className='gray800-13-opacity datause-edit-p'>
																	A description of the specific patient identifiable fields that have been included in the dataset(s) being
																	accessed
																</p>
																<Form.Control
																	readOnly={disableInput}
															...
															<Form.Group>
																...
																<Form.Control
																	...
																	{accessTypeList.map(l => (
																		<option selected={formik.values.accessType === l} value={l} key={l} eventKey={l}>
																			{l}
																		</option>
																	))}
																</Form.Control>
