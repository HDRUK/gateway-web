...
const DataUseUpload = React.forwardRef(({ onSubmit, team, dataUsePage, userState }, ref) => {
    ...
    const submitDataUse = () => {
        ...
        dataUseRegistersUpload.mutateAsync(payload).then(() => {
            ...
            dataUsePage.current.showAlert(
                'Submitted! The Gateway team will process your uploaded data uses and let you know when they go live.'
            );
        });
    };
            ...
            <Col>
                ...
                <div className='layoutCard p-4'>
                    ...
                    <p className='dataUseSubHeader mb-4'>
                        Please use the template provided to add new approved data uses . You can also download your current data use
                        register from the Gateway, edit offline and uploading the edited file here:{' '}
                    </p>
                    ...
                    <>
                        ...
                        {!isEmpty(uploadedData.rows) && isEmpty(uploadedData.uploadErrors) && (
                            <Alert variant='warning'>
                                Warning! Uploading a new file will delete any data uses that have not yet been submitted for admin checks by
                                the gateway team.
                            </Alert>
                        )}
                    </>
