export const data = [
	...
	},
	{
		...
		tags: {
			features: ['SITREP', 'Discover-NOW', 'Integrated Care', 'COVID-19', 'COVID', 'Pathway', 'Real World data', 'Linked longitudinal'],
			topics: [],
		},
		datasetfields: {
			publisher: 'HUB > DISCOVER NOW',
	...
	},
	{
		...
		tags: {
			features: ['A&E', 'Accident and Emergency', 'Discover-NOW', 'Integrated Care', 'Pathway', 'Real World data', 'Linked longitudinal'],
			topics: [],
		},
		datasetfields: {
			publisher: 'HUB > DISCOVER NOW',
