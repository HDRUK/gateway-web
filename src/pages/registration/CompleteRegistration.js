								...
								<Row>
									<Col sm={11} lg={11}>
										<Form.Control
											...
											name='lastname'
											type='text'
											className={formik.touched.lastname && formik.errors.lastname ? 'emptyFormInput addFormInput' : 'addFormInput'}
											onChange={formik.handleChange}
								...
								<Row>
									<Col sm={11} lg={11}>
										<Form.Control
											...
											name='email'
											type='text'
											className={formik.touched.email && formik.errors.email ? 'emptyFormInput addFormInput' : 'addFormInput'}
											onChange={formik.handleChange}
									...
									<Col
										...
										{inSectorHover && (
											<div className='accountClassToolTip accountSectorToolTip'>
												<span className='white-13-semibold'>{showingSector ? optionalShowFieldMsg : optionalHideFieldMsg}</span>
											</div>
										)}
										<button
											className='eye'
									...
									<Form.Group>
										<Row>
											...
											<Col
												...
												{inOrgHover && (
													<div className='accountClassToolTip accountSectorToolTip'>
														<span className='white-13-semibold'>{showingOrg ? optionalShowFieldMsg : optionalHideFieldMsg}</span>
													</div>
												)}
												<button
													className='eye'
							...
							<Form.Group className='pb-2'>
								...
								<Row>
									...
									<Col sm={1} lg={1} className='eyeColumn'>
										{inBioHover && (
											<div className='accountClassToolTip'>
												<span className='white-13-semibold'>{showingBio ? optionalShowFieldMsg : optionalHideFieldMsg}</span>
											</div>
										)}
										<button
											className='eye'
							...
							<Form.Group className='pb-2'>
								...
								<Row>
									...
									<Col
										...
										{inDomainHover && (
											<div className='accountClassToolTip'>
												<span className='white-13-semibold'>{showingDomain ? optionalShowFieldMsg : optionalHideFieldMsg}</span>
											</div>
										)}
										<button
											className='eye'
							...
							<Form.Group className='pb-2'>
								...
								<Row>
									...
									<Col sm={1} lg={1} className='eyeColumn' onMouseEnter={() => setLinkHover(true)} onMouseLeave={() => setLinkHover(false)}>
										{inLinkHover && (
											<div className='accountClassToolTip'>
												<span className='white-13-semibold'>{showingLink ? optionalShowFieldMsg : optionalHideFieldMsg}</span>
											</div>
										)}
										<button
											className='eye'
							...
							<Form.Group className='pb-2'>
								...
								<Row>
									...
									<Col
										...
										{inOrcidHover && (
											<div className='accountClassToolTip'>
												<span className='white-13-semibold'>{showingOrcid ? optionalShowFieldMsg : optionalHideFieldMsg}</span>
											</div>
										)}
										<button
											className='eye'
