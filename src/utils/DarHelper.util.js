 ...
 */
const injectReadonlyStaticContent = (jsonSchema = {}, activePanelId, publisherDetails) => {
    ...
    injectExportConfigContent(jsonSchema, pages, formPanels, questionPanels, publisherDetails);
